...
test_path = os.path.join(root_path, 'training_R01') # /media/NAS/NAS/tms_data/testing_data
model_save_path = os.path.join('/NAS/Synology/MultiCoilData/BrainCSF/Iso/2mm/Code/GP_data/code/Network_train_toy/models/Iso/')
print('model_saved_path:', model_save_path)
save_pred_path = os.path.join(root_path, 'pred_data_R01')
...
## testing
# load model
model_path = os.path.join(model_save_path, 'Initial.pth.tar')
