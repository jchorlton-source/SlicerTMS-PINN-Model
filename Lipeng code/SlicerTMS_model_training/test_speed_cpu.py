...
## root setting
root_path = '/rfanfs/pnl-zorro/home/gp88/software/anaconda3/doc/guoping_test/proj1_doc/simu_data'
train_path = os.path.join(root_path, 'training_data')
test_path = os.path.join(root_path, 'testing') # /media/NAS/NAS/tms_data/testing_data
model_save_path = os.path.join('/rfanfs/pnl-zorro/home/gp88/software/anaconda3/doc/guoping_test/proj1_doc/model_save_subj40_cond')
...
## testing
# load model
model_path = os.path.join(model_save_path, 'model_subj20_cond_res_epoch_39.pth.tar')
...
for i, data in enumerate(testloader):
    ...
    pred_time = os.path.join(test_path, 'pred_time'+str(i)+'.txt') 
...
#    print(y_target.size())
    ...
    currentDT = datetime.datetime.now()
    end_time = {'end time': str(currentDT)}
