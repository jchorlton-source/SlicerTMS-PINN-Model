...
## root setting
root_path = '/rfanfs/pnl-zorro/home/lipeng/NAS/Synology/simu_iso_cond/'
...
model_save_path = os.path.join('/rfanfs/pnl-zorro/home/lipeng/EfieldDL/Network_iso_cond/models')
...
if args.load_model:
    ...
    model_path = os.path.join(model_save_path, 'model_subj20_cond_res_epoch_10.pth.tar')
...
def train_model(trainloader, net, criterion, optimizer, 
    ...
    file_loss_train = open('models/info_train_loss_20subj_res_epoch23.txt', 'a')
    # file_loss_val = open('models/info_val_loss_20subj_res_cond.txt', 'a')
    file_epoch_time = open('models/epoch_time_23.txt', 'a')  
    # record time
    # write starting time
    ...
    num_steps = 0
    # save log
    # writer = SummaryWriter(log_dir="./log_20subj_cond_resunet_continue")   
    num_steps = 0
    ...
    for epoch in tqdm(range(next_epoch,num_epochs)):
        ...
        for i, data in enumerate(trainloader, 0): # index = 0
            ...
            #                         # write infor to file
            #                         val_loss_record = {'iter_number': num_steps, 'val_loss': val_mean, 'val_dice_mean': val_dice_mean}
            ...
            if num_steps % 5000 == 0 and args.local_rank == 0:
                ...
                model_save_name = "optimizer_subj20_cond_res_iter_%d.pth" % (num_steps)
                model_save = os.path.join(model_save_path, model_save_name)
                # save optimizer
...
f = open('models/infor_recored.txt', 'w')
