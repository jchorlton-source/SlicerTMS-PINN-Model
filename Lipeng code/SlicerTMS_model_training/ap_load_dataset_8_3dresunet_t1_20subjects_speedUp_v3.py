...
## root setting
root_path = '/run/media/Synology/simu_iso_cond/'
...
if args.load_model:
    ...
    model_path = os.path.join(model_save_path, 'model_subj20_t1_res_epoch_23_jogsh.pth.tar')
...
def train_model(trainloader, net, criterion, optimizer, 
    ...
    file_loss_train = open('model_save_subj20_t1/infor_train_loss_20subj_res_epoch23.txt', 'a')
#    file_loss_val = open('model_save_subj20_t1/infor_val_loss_20subj_res_cond.txt', 'a') 
    file_epoch_time = open('model_save_subj20_t1/epoch_time_23.txt', 'a')  
    # record time
    # write starting time
