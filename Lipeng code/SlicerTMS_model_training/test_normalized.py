...
test_path = '/rfanfs/pnl-zorro/home/lipeng/NAS/QNAP/MultiCoilData/AnisoCondData/GP_data/validation/normalized/' # os.path.join(root_path, 'testing_data') # /media/NAS/NAS/tms_data/testing_data
...
for i, data in enumerate(testloader):
    ...
    save_pred_path = os.path.join(test_path, 'normalized_pred')
