...
model_save_path = os.path.join('/rfanfs/pnl-zorro/home/gp88/software/anaconda3/doc/guoping_test/proj1_doc/model_save_subj20')
...
def train_model(trainloader, val_loader, net, criterion, optimizer, 
    ...
    file_loss_train = open('model_save_subj20/infor_train_loss_20subj_res_cond.txt', 'a')
    file_loss_val = open('model_save_subj20/infor_val_loss_20subj_res_cond.txt', 'a')  
    file_epoch_time = open('model_save_subj20/epoch_time.txt', 'a') 
    # record time
    # write starting time
