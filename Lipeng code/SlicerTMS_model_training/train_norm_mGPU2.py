...
## root setting
train_path = '/NAS/Synology/MultiCoilData/BrainCSF/Iso/2mm/Code/training_new/'
...
if args.load_model:
    ...
    model_path = os.path.join(model_save_path, 'NNewRetrained_isocond_epoch_200.pth.tar')
...
def train_model(trainloader, net, criterion, optimizer, 
    ...
    file_loss_train = open('models/Iso/infor_train_isocond_epoch200.txt', 'a')
    file_epoch_time = open('models/Iso/epoch_time.txt', 'a')  
    # record time
    # write starting time
...
f = open('models/Iso/infor_recored.txt', 'w')
